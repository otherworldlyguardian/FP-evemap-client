...
class LoggedInCard extends Component {
  ...
  render() {
    ...
    return (
      <Segment>
        <Button floated='right' inverted color='green' onClick={this.logout}>Logout</Button>
        <Button floated='right' inverted color='orange' onClick={this.mapReset}>Reset Map</Button>
        <Button floated='right' inverted color='red' onClick={this.mapDelete}>Delete Map</Button>
        <Item.Group>
          <Item>
